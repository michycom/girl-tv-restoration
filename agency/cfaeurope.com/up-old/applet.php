...
<pre style="font-size:100px;font-family:arial;font-weight:bold;">

</pre>
        <param name = "message" value="DRAG YOUR STUFF HERE.">
            <!-- edit the above line to customize the welcome message displayed. example
            value='http://www.radinks.com/upload/init.html' -->
        
        <param name='url' value='http://thespecial.org/up/upload.php'>
