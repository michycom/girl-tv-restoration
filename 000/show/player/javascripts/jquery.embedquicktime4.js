...
*/              
    if (o.eqttype == 'qt' || o.eqttype == 'audio') {
        ...
        $('#mov_container').html('<object width="540" height="'+height+'" autoplay="'+o.autoplay+'" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab"><param name="src" value="'+src+'"><param name="autoplay" value="'+o.autoplay+'">'+params+'<embed bgcolor="000000" volume="10" scale="aspect" src="'+src+'" width="540" height="'+height+'" controller="true" autoplay="'+o.autoplay+'" pluginspage="http://www.apple.com/quicktime/download/"'+embed+'></embed></object> ').append(share);
