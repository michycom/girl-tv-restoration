...
*/              
    if (o.eqttype == 'qt' || o.eqttype == 'audio') {
                           $('#movBG').fadeIn(77);
                            $('div#lang').fadeOut(100);
        $('#mov_container').html('<object width="'+width+'" height="'+height+'" autoplay="'+o.autoplay+'" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab"><param name="src" value="'+src+'"><param name="autoplay" value="'+o.autoplay+'">'+params+'<embed bgcolor="000000" volume="10" scale="aspect" src="'+src+'"width="'+screenW+'" height="'+height+'" controller="false" autoplay="'+o.autoplay+'" pluginspage="http://www.apple.com/quicktime/download/"'+embed+'></embed></object> ').append(share);

      }    
                    $("#mov_container").fadeIn("fast");
            
        $(".closeMov").fadeIn(6000);       
      return true;
    }
    return false;
  });
