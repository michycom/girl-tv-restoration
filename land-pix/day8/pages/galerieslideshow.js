...
if (document.cookie.length > 0)
    ...
    if (testCookie("galerieslide",1))
        {
        document.write('<a href="javascript:setShow('+ num +');">Diaschau Stop</a>');
        }
    else
        {
        document.write('<a href="javascript:setShow('+ num +');">Starte Diaschau</a>');
        }
    }
else
    {
...
if (document.cookie.length > 0)
    ...
    if (testCookie("galerieslide",1))
        {
        document.write('<form action="javascript:setShow('+ num +');"><input type="submit" value="&nbsp;Diaschau Stop&nbsp;"></form>');
        }
    else
        {
        document.write('<form action="javascript:setShow('+ num +');"><input type="submit" value="&nbsp;Starte Diaschau&nbsp;"></form>');
        }
    }
else
    {
...
if (document.cookie.length > 0)
    ...
    if (testCookie("galerieslide",1))
        {
        document.write('<a href="javascript:setShow('+ num +');"><img name="btnstop" src="showstop.gif" border="0" alt="Diaschau Stop"></a>');
        }
    else
        {
        document.write('<a href="javascript:setShow('+ num +');"><img name="btnstart" src="showstart.gif" border="0" alt="Starte Diaschau"></a>');
