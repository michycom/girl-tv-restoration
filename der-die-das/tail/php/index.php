...
if ($data == false)
{ 
	$data = getLog("/var/log/apache/master.log"); // Hier Datei angeben
...
pre {color:green; font-size:smaller;}
pre a:link, pre a:active, pre a:visited, pre a:hover {color:green; text-decoration:none;}
pre a:hover {font-weight:bold;}
</style>
<meta http-equiv="refresh" content="5; URL=testtail.php">
</head>
<body>
