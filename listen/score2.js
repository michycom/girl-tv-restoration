   class MusicalNote {
            ...
            this.drawNoteCircle(svg, 82, baseY);
            this.drawNote(svg);
            ...
            drawNote(svg) {
                ...
                noteText.setAttribute("x", "5");
                noteText.setAttribute("y", "25");
            ...
            drawNoteCircle(svg, xPosition, yPosition) {
    ...
    if (this.accidental) {
        ...
        accidentalText.setAttribute("y", yPosition + 7); // Etwas tiefer als die Note
