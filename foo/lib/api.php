...
$_services['setUserPermissions'] = array(
    'args' => array('shareRoot' => 'string', 'shareName' => 'string', 'userName' => 'string', 'permissions' => '{urn:horde}stringArray'),
    'type' => 'boolean'
);

$_services['setGroupPermissions'] = array(
    'args' => array('shareRoot' => 'string', 'shareName' => 'string', 'groupName' => 'string', 'permissions' => '{urn:horde}stringArray'),
    'type' => 'boolean'
);
...
function _horde_setUserPermissions($shareRoot, $shareName, $userName,
                                   $permissions)
{
}

function _horde_setGroupPermissions($shareRoot, $shareName, $groupName,
                                    $permissions)
{
}
