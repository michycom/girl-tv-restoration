<?php
	...
	define("jz_fg_color","#00FF00");
	define("jz_font_color","#FFFFFF");
	define("jz_link_color","#FFFFFF");
	define("jz_link_hover_color","#FFFF00");
	define("jz_headers","#FFFFFF");
	define("jz_row1","#009900");
	define("jz_row2","#005500");
	define("jz_select_bg","#00FF00");
	define("jz_select_font_color","#000000");
	define("jz_submit_bg","#000000");
	define("jz_submit_font_color","#00FF00");
	define("jz_input_bg","#000000");
	define("jz_input_font_color","#00FF00");
