<?php if (!defined(JZ_SECURE_ACCESS)) die ('Security breach detected.');
	...
	* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	class jzFrontend extends jzFrontendClass {
		...
		function footer(){
		  global $jinzora_url, $this_pgm, $version, $root_dir, $show_page_load_time, $skin, $show_jinzora_footer, $jzSERVICES, $cms_mode, $img_sm_logo;
			...
			if ($show_jinzora_footer){
				...
				$smarty->assign('small_logo', $img_sm_logo);
