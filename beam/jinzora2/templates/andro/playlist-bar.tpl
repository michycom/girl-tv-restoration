	...
	<table width="100%" cellspacing="0" cellpadding="3">
		<tr class="and_head1">
			<td width="100%">
				...
				<a style="cursor:hand" onClick="CheckBoxes('albumForm',true); return false;" href="javascript:;">{$img_check}</a>
				<a style="cursor:hand" onClick="CheckBoxes('albumForm',false); return false;" href="javascript:;">{$img_uncheck}</a>	
				{$addListButton}
				{$hidden_1}
				{$hidden_2}
				{$playlist_button}
